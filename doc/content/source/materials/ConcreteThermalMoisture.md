...
## Coupled moisture and heat transfer model

This class presents a set of constitutive models (from [!cite](victoYann)) and parameters for moisture diffusion and heat transfer in concrete . The equivalent moisture diffusion/heat transfer model [!cite](bavzant1979pore,bavzant1982finite,xi1994moisture,xi_moisture_1994) has been implemented
in Grizzly, along with the full set of constitutive models compiled by [!cite](victoYann). The following sections provide a detailed descriptions of the governing equations and associated constitutive laws for the coupled moisture diffusion and heat transfer model.

## Heat transfer model

### Governing equation

The governing partial differential equation for heat transfer in concrete is given by [!cite](bavzant1982finite) and [!cite](victoYann) as:
...
\frac{\partial}{\partial z} \left(k\frac{\partial T}{\partial z}\right) - C_w \mathbf{J} \nabla T + C_a\frac{\partial{W}}{\partial{H}}\frac{\partial{H}}{\partial{t}} + Q
...
The first term on the right side of [!eqref](thermal_governing) represents the thermal conduction; the second term represents the convective transport of heat due to fluid flow;
and the third term represents adsorption heat due to adsorption of free water molecules in pores onto pore walls. The mass density and isobaric (constant pressure)
heat capacity of liquid water $C_w$ is given by
...
and $C_{water}$ is the isobaric (constant pressure) heat capacity of liquid water in J/kg$°$C. The values of $C_{water}$
are tabulated in [!cite](yunus2011heat). The adsorption heat $C_a$ usually can be neglected according to [!cite](bavzant1982finite). Thus, in Grizzly, a small fraction of the concrete specific heat capacity $C$ value is simply assigned to $C_a$ (i.e., $C_a=0.001 \times C$).

### Thermal capacity

Following [!cite](victoYann), four constitutive models were implemented in Grizzly for concrete thermal capacity  $\rho C$ (in MJ/m$^3°$C ):
...
- Siliceous aggregate concrete
  ...
  \rho C = \left\{\begin{array}{lll}
          0.005T + 1.7 & \text{for} & 20° \text{C} \le T \le 200 ° \text{C} \\
          2.7 & \text{for} & 200° \text{C} \le T \le 400 ° \text{C} \\
          0.013T - 2.5 & \text{for} & 400° \text{C} \le T \le 500 ° \text{C} \\
          10.5 - 0.013T & \text{for} & 500° \text{C} \le T \le 600 ° \text{C} \\
          2.7 & \text{for} & T > 600 ° \text{C}
      \end{array}\right.
...
- Carbonate aggregate concrete
  ...
  \rho C = \left\{\begin{array}{lll}
          2.566 & \text{for} & 20 ° \text{C} \le T \le  400 ° \text{C} \\
          0.1756T - 68.034 & \text{for} & 400 ° \text{C} \le T \le  410 ° \text{C} \\
          25.00671 - 0.05043T & \text{for} & 410 ° \text{C} \le T \le  445 ° \text{C} \\
          2.556 & \text{for} & 445 ° \text{C} \le T \le  500 ° \text{C} \\
          0.01603T - 5.44881 & \text{for} & 500 ° \text{C} \le T \le  635 ° \text{C} \\
          0.16635T - 100.90225 & \text{for} & 635 ° \text{C} \le T \le 715 ° \text{C} \\
          176.07343 - 0.22103T & \text{for} & 715 ° \text{C} \le T \le  785 ° \text{C} \\
          2.566 & \text{for} & T > 785 ° \text{C}
      \end{array}\right.

  Note that $\rho C$ is in units of MJ/m$^3{°}$C in this particular thermal capacity model.
...
\rho C = \left\{\begin{array}{lll}
        ...
        0.013T - 2.5 & \text{for} & 400° \text{C} \le T \le 500 ° \text{C} \\
        10.5 - 0.013T & \text{for} & 500° \text{C} \le T \le 600 ° \text{C} \\
        2.7 & \text{for} & 600 ° \text{C} \le T \le 635 ° \text{C}
    \end{array}\right.
...
- Carbonate aggregate concrete
  ...
  \rho C = \left\{\begin{array}{lll}
          2.45 & \text{for} & 20 ° \text{C} \le T \le  400 ° \text{C} \\
          0.026T - 12.85 & \text{for} & 400 ° \text{C} \le T \le  475 ° \text{C} \\
          0.0143T - 6.295 & \text{for} & 475 ° \text{C} \le T \le  650 ° \text{C} \\
          0.1894T - 120.11 & \text{for} & 650 ° \text{C} \le T \le  735 ° \text{C} \\
          -0.263T + 212.4 & \text{for} & 735 ° \text{C} \le T \le  800 ° \text{C} \\
          2.0 & \text{for} & 800 ° \text{C} \le T \le 1000 ° \text{C}
      \end{array}\right.
...
\rho = \left\{\begin{array}{lll}
      \rho_{ref} & \text{for} & 20° \text{C} \le T \le 115 ° \text{C} \\
      \rho_{ref}\left(1 - \frac{0.02(T-115)}{85}\right) & \text{for} & 115° \text{C} \le T \le 200 ° \text{C} \\
      \rho_{ref}\left(0.98 - \frac{0.03(T-200)}{200}\right) & \text{for} & 200° \text{C} \le T \le 400 ° \text{C} \\
      \rho_{ref}\left(0.95 - \frac{0.07(T-400)}{800}\right) & \text{for} & 400° \text{C} \le T \le 1200 ° \text{C} \\
      \end{array}\right.

where $\rho_{ref}$ is reference concrete density (in kg/m$^3$) at 20$°$C and the equation for specific heat of concrete (in J/kg$°$C) is given by

!equation id=C_euro
C = \left\{\begin{array}{lll}
        900 & \text{for} & 20 ° \text{C} \le T \le  100 ° \text{C} \\
        900 + (T-100) & \text{for} & 100 ° \text{C} \le T \le  200 ° \text{C} \\
        1000 + \left(\frac{T-200}{2}\right) & \text{for} & 200 ° \text{C} \le T \le  400 ° \text{C} \\
        1100 & \text{for} & 400 ° \text{C} \le T \le 1200 ° \text{C}
    \end{array}\right.
...
Also Following [!cite](victoYann), four thermal conductivity models were implemented in Grizzly, all depending on the temperature and concrete texture,
including
...
k = \left\{\begin{array}{lll}
        -0.000625T + 1.5 & \text{for} & 20 ° \text{C} \le T \le 800 ° \text{C}\\
        1.0 & \text{for} & T>800 ° \text{C}
    \end{array}\right.
...
k = \left\{\begin{array}{lll}
        1.355 & \text{for} & 20 ° \text{C} \le T \le 293 ° \text{C}\\
        1.0 & \text{for} & T>293 ° \text{C}
    \end{array}\right.
...
k = \begin{array}{lll}
        0.85(2-0.0011T) & \text{for} & 20 ° \text{C} \le T \le 1000 ° \text{C}\\
    \end{array}
...
!equation id=k_carb_ASCE
k = \left\{\begin{array}{lll}
        0.85(2-0.0013T) & \text{for} & 20 ° \text{C} \le T \le 300 ° \text{C}\\
        0.85(2.21-0.002T) & \text{for} & T>300 ° \text{C}
    \end{array}\right.
...
!equation id=euro_ul
\begin{array}{lll}
k = 2-0.2451\left(\frac{T}{100}\right) + 0.0107\left(\frac{T}{100}\right)^2 & \text{for} & 20 ° \text{C} \le T \le 1200 ° \text{C}\\
\end{array}
...
!equation id=euro_ll
\begin{array}{lll}
k = 1.36 - 0.136\left(\frac{T}{100}\right) + 0.0057\left(\frac{T}{100}\right)^2 & \text{for} & 20 ° \text{C} \le T \le 1200 ° \text{C}\\
\end{array}
...
[!cite](victoYann) compiled
and provided a comprehensive set of constitutive models and parameters for moisture diffusion in concrete structures, which were also implemented in the Grizzly
code. Detailed descriptions of the governing equation and constitutive models for moisture diffusion are provided here.

### Governing equation

Following [!cite](victoYann), the governing equation for moisture diffusion in concrete is formulated by using relative humidity $H$ as the primary variable:
...
Two important parameters, moisture capacity ${\partial W}/{\partial H}$ and moisture diffusivity $D_h$, both depend on the relative humidity $H$. Thus the moisture diffusion
governing equation is highly nonlinear. The following sections describes in detail the constitutive models for this two parameters.

### Moisture capacity

[!cite](xi1994moisture,xi_moisture_1994) developed a concrete moisture capacity model based on the Brunauer-Emmett-Teller (BET) adsorption isotherm theory,
which was implemented in Grizzly. The total water content $W$ in concrete at a constant temperature $T$ is referred as water adsorption isotherm, which was
proposed by [!cite](xi1994moisture) as:
...
- **Monolayer capacity, $V_m$**
  ...
  - **Cement Paste:**
    ...
    V_t(t) = \left\{\begin{array}{llll}
            0.068 - \frac{0.22}{t} & for & t > 5 & days \\
            V_t(5) & if & t \le 5 & days
             \end{array}\right.\\
    V_{wc}(w/c) = \left\{\begin{array}{llll}
            0.85 + 0.45\frac{w}{c} & for & 0.3<w/c < 0.7 &\\
...
- **Empirical constant $k$**
  ...
  - **Cement Paste:**
    ...
    N_t(t) = \left\{\begin{array}{llll}
            2.5 + \frac{1.5}{t_e} & for & t > 5 & days \\
            5.5 & if & t \le 5 & days
             \end{array}\right.\\
    N_{wc}(w/c) = \left\{\begin{array}{llll}
            0.33 + 2.2\frac{w}{c} & for & 0.3 < w/c < 0.7 & days \\
...
interact, such as molecular diffusion in large pores (usually 50nm - 10 microns and beyond) and microcracks, Knudson diffusion in mesopores (2.5nm - 50 nm) and
 micropores ($<$2.5nm) and surface diffusion along pore walls [!cite](victoYann). Most existing moisture diffusivity models typically do not account for individual diffusion
mechanisms separately. Instead, they tend to reproduce the general combined trend.

In Grizzly, calculation of $D_h$ starts with the calculation of a reference moisture diffusivity $D_{h,0}$ at a given temperature $T$ and relative humidity $H$. Three reference
moisture diffusivity $D_{h,0}$ models are implemented as:
...
3. [!cite](bavzant1982finite) (in units of $m^2/s$)
...
f_H = \left\{\begin{array}{lll}
        \alpha_D + \frac{1-\alpha_D}{1+\left(\frac{1-H}{1-0.75}\right)^n} & for & T \le 95\degree C\\
        1 & for & T > 95 \degree C
    \end{array}\right.
...
where $T$ is in $°$C. $\alpha \in [0.037:1]$ from $T\in[0° C : 95° C]$ and $n\in[6:16]$.
...
D_h = \left\{\begin{array}{lll}
        D_{h, 0}f_1(T) & for & T \le 95 \degree C \\
        D_{h, 0}f_1(95\degree C)f_2(T) & for & T > 95 \degree C
    \end{array}\right.
...
!equation id=f1T
\begin{array}{lll}
    f_1(T) = e^{\frac{Q}{R}\left(\frac{1}{T_{ref}}-\frac{1}{T}\right)} & for & T \le 95° C
\end{array}
...
!equation id=f2T
\begin{array}{lll}
    f_2(T) = e^{\frac{T-95}{0.881 + 0.214(T-95)}} & for & T > 95° C
\end{array}
...
It has been reported by Bazant et al. [!cite](bavzant1982finite) that the additional moisture diffusion due to thermal gradients included in the moisture governing equation
is negligible. Thus the value of $D_{ht}$ is set to 0.0 by default in Grizzly. Users can, however, set this parameter to an arbitrary value if desired.    
