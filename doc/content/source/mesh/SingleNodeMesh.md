...
The `SingleNodeMesh` creates a mesh with a single node and a single +NODEELEM+ element, suitable for zero-dimensional (point) nodal simulations such as a 0-D cluster dynamics problem using [GenericClusterDynamicsNodalKernel.md].
