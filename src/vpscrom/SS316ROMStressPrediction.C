...
SS316ROMStressPrediction::computeDerivative(const Real effective_trial_stress, const Real scalar)
{
  ...
  _ss316_rom_calculations.computeROMDerivative(_dt, _mobile_dislocations_old[_qp], _immobile_dislocations_old[_qp], trial_stress_mpa, effective_strain_old, _temperature[_qp], derivative_rom_effective_strain);
