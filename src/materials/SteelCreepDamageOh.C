...
SteelCreepDamageOhTempl<is_ad>::SteelCreepDamageOhTempl(const InputParameters & parameters)
  : ScalarDamageBaseTempl<is_ad>(parameters),
    ...
    _creep_model(),
    _combined_creep(this-> template declareGenericProperty<RankTwoTensor, is_ad>("combined_creep")),
    _combined_creep_old(this->template getMaterialPropertyOld<RankTwoTensor>("combined_creep")),
