...
[Materials]
 ...
 [ASR_expansion]
   ...
   reference_temperature  = 25.0                # parameter to play
   temperature_unit = Celsius
   max_volumetric_expansion = 3.1e-2            # parameter to play

   characteristic_time = 30                     # parameter to play
   latency_time = 30.0                          # parameter to play
